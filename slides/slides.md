...
<!--
- 개발은 한 번에 끝나지 않습니다. 계속 수정하고 검증하는 과정의 반복이죠.
- Git은 그 변경사항을 기록하고, 무엇이 달라졌는지 비교하게 해줍니다.
- 그리고 문제가 생기면 언제든 이전 상태로 안전하게 되돌릴 수 있습니다.
- 그래서 많은 회사가 코드나 문서의 변경 이력을 관리하고, 다른 사람과 충돌 없이 협업하는 능력을 기본기로 요구합니다.
-->
